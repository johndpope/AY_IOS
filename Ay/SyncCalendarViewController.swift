                ...
                event_store.enumerateEventsMatchingPredicate(predicate, usingBlock:{
                    ...
                    if (event.title != nil
                        ...
                        && event.lastModifiedDate != nil
                            ...
                            ParseCoreService().createEvent(new_event.participants, title: new_event.title, start: new_event.start_time!, end: new_event.end_time!, alarm: nil, recur_end: nil, recur_freq: nil, recur_occur: 0, location: new_event.location)
